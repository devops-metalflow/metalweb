...
import { OriginRouteItem } from '/@/api/sys/model/menuModel';
    ...
    async buildRoutesAction(): Promise<AppRouteRecordRaw[]> {
      ...
      switch (permissionMode) {
        ...
        case PermissionModeEnum.BACK:
          ...
          let originList: OriginRouteItem[] = [];
          try {
            // this.changePermissionCode();
            originList = (await getMenuTree()) as OriginRouteItem[];
          } catch (error) {
            console.error(error);
          }
          routeList = transOriginToRoute(originList);
